...
gmt psbasemap -R119/123/21/26 -Jm3 -B1 -G0/250/250 -P -O -K >> $out_ps
...
echo "121.87 24.8 M:4.6 Depth:5.9km" | gmt pstext -R -J -O -K -F+f,Helvetica-Bold,black >> $out_ps
